...
const Home = () => {
  ...
  const [$_lastRescue, $_setLastRescue] = useState<any>(null);
  ...
  const $isAlreadyRescue = useCallback(async () => {
    console.log("test");
    try {
        ...
        {$_lastRescue && $_lastRescue?._id ? (
          <View style={{ padding: 10 }}>
            ...
            <MapView
              ...
              showsTraffic={false}
              showsScale={true}
              style={{ alignSelf: "stretch", height: "100%", marginTop: 5 }}
              region={{
                latitude: -8.5869,
                longitude: 116.0922,
              ...
              onPress={(_event) => console.log(_event.nativeEvent.coordinate)}
            >
              <Circle
                center={{
                  latitude: -8.5871886,
